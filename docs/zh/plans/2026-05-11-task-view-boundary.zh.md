...
- 如果 message behavior 变化，更新 `docs/archive/features/03-discord-task-output.md` 或等价 Discord output doc。
...
- `docs/architecture.md` 和 `docs/archive/features/03-discord-task-output.md`：更新 task runtime docs，描述 runner/view/trace split 以及已完成的 Discord view reporter phase。
- 验证：
