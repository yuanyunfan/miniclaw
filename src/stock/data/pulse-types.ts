...
import type { StockPortfolioPositionPremiumSummary } from "./portfolio-types.js";
...
export type StockPulsePortfolioRunner = (args: StockProviderRunArgs) => Promise<StockProviderResult>;
