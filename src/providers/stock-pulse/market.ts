import type { StockPulseMarket, StockPulseMarketConfig, StockPulseTimeWindow } from "./types.js";
...
export function isActiveWindow(date: Date, window: StockPulseTimeWindow): boolean {
...
export function isMarketOpen(date: Date, market: StockPulseMarketConfig): boolean {
...
export function openMarketsAt(
  date: Date,
  markets: Partial<Record<StockPulseMarket, StockPulseMarketConfig>>,
): StockPulseMarket[] {
  return (Object.entries(markets) as Array<[StockPulseMarket, StockPulseMarketConfig]>)
